			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="<c:url value="/post/list"/>">게시글 목록</a></li>
					<c:if test="${user == null}">
						<li class="nav-item"><a class="nav-link"
							href="<c:url value="/signup"/>">회원 가입</a></li>
						<li class="nav-item"><a class="nav-link"
					...
					<li class="nav-item dropdown"><a
						...
						data-toggle="dropdown"> 예제 </a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="<c:url value="/example" />">데이터
								전송 예제</a> <a class="dropdown-item" href="<c:url value="/jstl" />">JSTL</a>
